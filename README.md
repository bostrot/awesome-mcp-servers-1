...
- **[WSL Manager](https://github.com/bostrot/wsl2-distro-manager)** - Drive WSL distros on Windows and native Linux VMs on macOS from MCP clients: create, import, configure, run, package and remove instances, run commands in persistent terminal sessions, manage snippets and disk mounts. Built into the WSL Manager desktop app (Pro).
